<x-guest-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
            ...
            <div class="flex">
                <a href="{{route('cart.index', [request('subdomain')])}}" class="relative mr-8">
                ...
                @auth
                    ...
                    <a 
                    href="{{route('my.orders', request('subdomain'))}}"
        ...
        <div class="grid grid-cols-3 gap-1 mt-20">
            @forelse($store->products as $product)
                <div class="p-2 border border-gray-200 mb-8">
                    ...
                    <a href="{{route('cart.add', [request('subdomain'), 'product' => $product->slug])}}" class="underline text-blue-500 mt-8 block">Comprar</a>
                </div>
            @empty
